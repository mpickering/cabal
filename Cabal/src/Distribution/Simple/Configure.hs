...
import Distribution.Simple.Program.Db (ProgramDb (..), lookupProgramByName, updateConfiguredProgs)
  ...
  externalPkgDeps =
    do
      ...
      let cbd =
          ...
          pbd =
            pbd0
              { LBC.extraCoverageFor =
                  LBC.extraCoverageFor pbd0 ++ extraCoverageUnitIds
              }
