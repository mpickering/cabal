...
Introduced in Cabal 3.12, this build type provides an alternative
...
To use this build type in your package, you need to:
  ...
  * Declare a ``cabal-version`` of at least 3.12 in your ``.cabal`` file.
...
Deprecated since Cabal 3.12: prefer using the :ref:`Hooks build type<setup-hooks>` instead.
